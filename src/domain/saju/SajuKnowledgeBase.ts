...
export const SAJU_RULES: SajuKnowledgeRule[] = [
  ...
  { id: 'compatibility.two-charts', topic: 'compatibility', title: '두 차트 비교', rule: '두 사람의 일간·오행·지지 관계를 비교하고 우열이나 관계의 결과를 단정하지 않습니다.', sourceReference: '두 차트의 오행 교차·지지 관계 비교 규칙', confidence: '낮음' },
  { id: 'compatibility.twelve-growth', topic: 'compatibility', title: '십이운성의 관계 리듬', rule: '각자의 일간이 일지에서 어떤 십이운성에 놓이는지 비교해 관계의 속도·회복·표현을 질문으로 만듭니다.', sourceReference: '십이운성 순환 단계를 관계 해석에 비결정적으로 적용한 규칙', confidence: '낮음' },
